...
# social-engine modules (social_config, social_body_renderer, social_notion)
# live in the sibling social-engine package
sys.path.insert(0, str(Path(__file__).parent.parent / "social-engine"))
